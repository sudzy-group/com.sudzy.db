...
var twoDigitsLong_1 = require("../validators/twoDigitsLong");
...
], CustomerCard.prototype, "exp_month");
__decorate([
    pouchable_1.EntityField({
        group: "default",
        name: "exp_year",
...
], CustomerCard.prototype, "exp_year");
__decorate([
    pouchable_1.EntityField({
        group: "settings",
        name: "is_default",
...
], CustomerCard.prototype, "is_forgotten");
__decorate([
    pouchable_1.EntityField({
        group: "settings",
        name: "in_stripe",
...
], CustomerCard.prototype, "in_stripe");
__decorate([
    pouchable_1.EntityField({
        group: "settings",
        name: "stripe_token",
...
], CustomerCard.prototype, "stripe_token");
